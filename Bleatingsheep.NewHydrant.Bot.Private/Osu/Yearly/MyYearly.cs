    ...
    public partial class MyYearly : IMessageCommand
    {
        ...
        public async Task ProcessAsync(MessageContext context, HttpApiClient api)
        {
            ...
            }
            {
                ...
                sb.AppendLine($"你在过去一年中有 {days} 天打了图，合计 {userInfo.PlayCount - snap.UserInfo.PlayCount} 次，{userInfo.TotalHits - snap.UserInfo.TotalHits} TTH，{(userInfo.PlayTime - snap.UserInfo.PlayTime).TotalHours:#.##} 小时。");
            }
            {
                // most played
